  ...
  return (
    <Layout>
      ...
      <div className="main-wrapper relative z-10">
          ...
          <div className="container mx-auto px-4 py-20">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <Content className="text-gray-600 text-lg">
                Material completo e organizado para maximizar seu aprendizado
              </Content>
            </div>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-secondary-500/10 rounded-xl flex items-center justify-center mb-6">
                    <span className="text-secondary-500 text-2xl">{feature.icon}</span>
                  </div>
        ...
        <SectionContainer className="bg-[#F3F5F8] mt-20">
          <div className="container mx-auto px-4 pt-20">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <Content className="text-gray-600 text-lg">
                Conteúdo objetivo e organizado para facilitar seu aprendizado
              </Content>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-4 md:px-0">
              ...
              <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[8px] md:border-[16px] rounded-t-xl h-[592px] max-w-[512px] md:h-[672px] md:max-w-[912px]">
                <div className="rounded-lg overflow-hidden h-[560px] md:h-[640px] bg-white">
                  ...
                  <div className="h-full overflow-y-auto notion-content bg-white" style={{ fontFamily: 'ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, "Apple Color Emoji", Arial, sans-serif, "Segoe UI Emoji", "Segoe UI Symbol"' }}>
                    {/* Notion Top Bar */}
                      ...
                      <div className="flex items-center px-4 md:px-8 h-12">
                        <div className="flex items-center space-x-4 text-gray-500">
                          ...
                          <div className="flex items-center space-x-1 text-sm">
                            <span>Pediatria</span>
                            <span>/</span>
                            <span>Arritmia, Síncope e PCR</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="px-4 md:px-[calc(max(96px,calc(96px+env(safe-area-inset-left))))] pt-16 pb-10">
                      {/* Page Title */}
                      <h1 className="text-4xl font-bold mb-10">Arritmia, Síncope e PCR</h1>
                      ...
                      <div className="mb-12">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          ...
                          <div className="space-y-1">
                            <div className="text-sm text-gray-500">Grande área</div>
                      ...
                      <div className="mb-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <div className="space-y-1">
                          <a href="#morte-subita" className="block text-gray-600 hover:bg-gray-100 rounded px-2 py-1 text-sm">
                            1. Morte súbita em lactente
                          </a>
                          <a href="#brue" className="block text-gray-600 hover:bg-gray-100 rounded px-2 py-1 text-sm">
                            2. BRUE
                          </a>
                          <a href="" className="block text-gray-600 hover:bg-gray-100 rounded px-2 py-1 text-sm">
                            3. ...
                          </a>
                        </div>
                      </div>
                      ...
                      {/* Content Sections */}
                      <div id="morte-subita" className="space-y-6">
                        <div className="group">
                        ...
                        <div className="pl-4 border-l-4 border-gray-200 space-y-4">
                          <h3 className="text-lg font-semibold mb-2 text-gray-800">Definição</h3>
                          <ul className="list-disc pl-6 space-y-1 mb-6 text-gray-600">
                            <li>Morte súbita e inesperada em menores de 1 ano de idade</li>
                            <li>Durante o sono</li>
                            <li>Não pode ser explicada após a avaliação pós-morte</li>
                          </ul>

                          <h3 className="text-lg font-semibold mb-2 text-gray-800">Incidência</h3>
                          <ul className="list-disc pl-6 space-y-1 mb-6 text-gray-600">
                            <li>Pico entre 2 e 4 meses</li>
                            <li>Menos comum depois dos 8 meses</li>
                          </ul>

                          <h3 className="text-lg font-semibold mb-2 text-gray-800">Fisiopatologia</h3>
                          <ul className="list-disc pl-6 space-y-1 mb-6 text-gray-600">
                            <li>Ainda desconhecida</li>
                            <li>Criança vulnerável</li>
                            <li>Período crítico</li>
                            <li>Fatores desencadeantes</li>
                          </ul>

                          <h3 className="text-lg font-semibold mb-2 text-gray-800">Fatores de Risco</h3>
                          <div className="pl-6 space-y-4 mb-6">
                            <div className="p-4 bg-gray-50 rounded-lg">
                              <div className="font-medium text-gray-800 mb-2">Epidemiológicos</div>
                              <ul className="list-disc pl-6 space-y-1 text-gray-600">
                                <li>Baixo nível socioeconômico</li>
                                <li>Posição prona/ lateral</li>
                                <li>Cama compartilhada</li>
                                <li>Cama fofa e macia</li>
                              </ul>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-lg">
                              <div className="font-medium text-gray-800 mb-2">Maternos e pré-natal</div>
                              <ul className="list-disc pl-6 space-y-1 text-gray-600">
                                <li>Tabagismo</li>
                                <li>Doenças mentais</li>
                                <li>Abuso de substâncias</li>
                              </ul>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-lg">
                              <div className="font-medium text-gray-800 mb-2">Lactente</div>
                              <ul className="list-disc pl-6 space-y-1 text-gray-600">
                                <li>Prematuridade</li>
                      ...
                      {/* BRUE Section */}
                      <div id="brue" className="space-y-6 mt-12">
                        <div className="group">
                          <h2 className="text-xl font-bold mb-3 text-gray-900 flex items-center gap-2">
                            <div className="opacity-0 group-hover:opacity-100 transition-opacity text-gray-400">
                              <button className="hover:bg-gray-100 p-1 rounded">
                        ...
                        <div className="pl-4 border-l-4 border-gray-200 space-y-4">
                          <div className="space-y-3 text-gray-600">
                            <div className="p-4 bg-gray-50 rounded-lg">
                              <p className="mb-3">Evento súbito, breve e já resolvido (ao chegar no hospital) em criança de até 1 ano com pelo menos uma característica:</p>
                              <ul className="list-disc pl-6 space-y-1">
                                <li>Cianose ou palidez</li>
                                <li>Esforço respiratório, ausente, diminuído ou irregular</li>
                                <li>Alteração do tônus muscular (hiper ou hipotonia)</li>
                                <li>Alteração da responsividade</li>
                              </ul>
                            </div>
                          </div>
                          ...
                          <div className="py-2 text-gray-600">
                            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-100">
                              <p>O termo só deve ser usado para crianças assintomáticas no momento da avaliação e quando não há nenhuma explicação para o episódio encontrado no exame físico ou na história clínica</p>
                            </div>
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                              <ul className="list-disc pl-6 space-y-1 text-gray-600">
                                ...
                                <li>Sintomas respiratórios recentes</li>
                                <li>Idade &lt; 2 meses</li>
                                <li>História prévia de BRUE</li>
                                <li>Prematuridade</li>
                                <li>Baixo peso ao nascer</li>
                                <li>Tabagismo materno</li>
                              </ul>
                            </div>
                          </div>
                      ...
                      <div className="mt-16 border-t border-gray-200 pt-8 text-center">
                        <div className="inline-flex items-center space-x-2 text-gray-500">
                          <span className="text-2xl leading-[1]">....</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <SectionContainer className="bg-slate-900 py-20 px-4 scroll-mt-10" id="cta-anotacoes">
          <div className="text-center mx-auto mb-12 max-w-xl">
            ...
            <p className="mt-6 text-lg text-slate-300">
              Aproveite as condições especiais de lançamento e tenha acesso ao material que me ajudou a conquistar a aprovação na residência médica
            </p>
          </div>
...
const features = [
  {
    ...
    description: "40 temas essenciais incluindo insuficiência cardíaca, arritmias, síncope, PCR, síndromes coronarianas e diagnósticos diferenciais."
  },
  {
    icon: "⚕",
    title: "Cirurgia Médica ",
    description: "30 temas fundamentais como trauma de face e pescoço, queimaduras, trauma abdominal, hérnias e muito mais."
  },
  {
    icon: "🤰",
    title: "GO ",
    description: "31 temas incluindo ciclo menstrual, pré-natal, dor pélvica crônica, assistência ao parto e doenças benignas da mama."
  },
  {
    icon: "👶",
    title: "Pediatria ",
    description: "26 temas cruciais cobrindo desde distúrbios obstrutivos até crescimento e desenvolvimento, tuberculose e síndromes febris."
  },
  {
    icon: "🏥",
    title: "Medicina Preventiva",
    description: "14 temas, como SUS, estatística dos testes diagnósticos, níveis de prevenção e documentação médica."
  },
  {
    icon: "📚",
    title: "Tudo em um só lugar",
    description: "Mais de 2 mil horas de estudo condensados em +140 anotações com conteúdo objetivo e focado no que importa para aprovação."
  }
]; 